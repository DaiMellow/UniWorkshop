    ...
    <div class="mod-item" :class="{ disabled: modData.status !== 'enabled' }">
        ...
        <div class="mod-actions">
            <div class="button-row">
                ...
                <button class="button" v-if="modData.status == 'enabled' && !processing"
                    style="background-color: #353535;">
                    <i class="fas mini-icon fa-ban"></i> Disable
                </button>
                <button class="button" v-if="processing" style="background-color: #4a4a6a;">
    ...
    data() {
        return {
            modData: {
                ...
                "status": "enabled",
                "autoUpdate": 1,
                "created_at": "2025-04-10 18:16:44",
                "updated_at": "2025-04-10 18:16:44"
            },
            processing: false,
        };
    },
